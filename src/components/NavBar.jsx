        ...
        <Accordion className='accordion-base'>
              <AccordionItem>
                ...
                <AccordionBody className='accordion z10'>
                  <a className='header-link first' onClick={() => {navigate("/Terapias")}}>Serviços</a>
                  <a className='header-link' onClick={() => {navigate("/Blog")}}>Blog</a>
                  <a className='header-link last' onClick={() => {navigate("/Acupuntura-em-Santos")}}>Sobre nós</a>
                </AccordionBody>
              </AccordionItem>
            </Accordion>
        </nav>
          ...
          <nav className='background-navbar'>
            ...
            <div className='links'>
                <div className={location.pathname === "/Terapias" ? 'down-bar not-last div-link' : 'not-last div-link'}>
                    <a className={location.pathname === "/Terapias" ? 'selected' : 'header-link'} onClick={() => {navigate("/Terapias")}}>Serviços</a>
                </div>
                <div className={location.pathname === "/Blog" ? 'down-bar not-last div-link' : 'not-last div-link'}>
                    <a className={location.pathname === "/Blog" ? 'selected' : 'header-link' }  onClick={() => {navigate("/Blog")}}>Blog</a>
                </div>
                <div className={location.pathname === "/Acupuntura-em-Santos" ? 'down-bar div-link' : 'div-link'}>
                    <a className={location.pathname === "/Acupuntura-em-Santos" ? 'selected' : 'header-link' }  onClick={() => {navigate("/Acupuntura-em-Santos")}}>Sobre nós</a>
                </div>
            </div>
