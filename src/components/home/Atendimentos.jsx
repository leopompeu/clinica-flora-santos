    ...
    return (
        <section id="Atendimentos" className='section-atendimentos-mobile'>
            ...
            <div className='card-atendimento-mobile'>
                <img src={acupunturaParticularEmSantos} className='img-atendimento' alt='Ícone que representa o atendimento particular de acupuntura em Santos'/>
            ...
            <div className='card-atendimento-mobile'>
                <img src={acupunturaConvenioEmSantos} className='img-atendimento' alt='Ícone que representa o atendimento por convênio de acupuntura em Santos'/>
            ...
            <div className='card-atendimento-mobile'>
                <img src={acupunturaPopularEmSantos} className='img-atendimento' alt='Ícone que representa o atendimento popular de acupuntura em Santos'/>
    ...
    return (
        <section id="Atendimentos" className='section-atendimentos'>
            ...
            <div className='atendimentos'>
                ...
                <div className='card-atendimento'>
                    <img src={acupunturaConvenioEmSantos} className='img-atendimento' alt='Ícone que representa o atendimento à convênio para acupuntura em Santos'/>
