  ...
  if(isMobile) {
    return (
        <section id="Chamariz" className='section-chamariz-mobile'>
          ...
          <img src={acupunturaEmSantos} alt='Acupuntura em santos, é na Clínica Flora Santos' className='image-chamariz-mobile'/>
        </section>
    )
  } else {
    return (
        <section id="Chamariz" className="section-chamariz">
            <div className='chamariz-content'>
                <img src={acupunturaEmSantos} alt='Acupuntura em santos, é na Clínica Flora Santos' className='image-chamariz'/>
                <div>
