            ...
            <div className='carousel-div-mobile'>
                <Carousel 
                        ...
                        <div className='item-div-mobile'>
                            <img src={imageAcupuntura} loading='lazy' className='image-mobile' alt='Foto de um sessão de acupuntura'/>
                            <div className='item-text-div-mobile'>
                                <div className='title-item-div-mobile'>
                                    <img src={iconAcupuntura} loading='lazy' className='img-item' alt='Icone para representar a acupuntura'/>
                        ...
                        <div className='item-div-mobile'>
                            <img src={imagemVentosaterapia} loading='lazy' className='image-mobile' alt='Foto de um sessão de ventosaterapia'/>
                            <div className='item-text-div-mobile'>
                                <div className='title-item-div-mobile'>
                                    <img src={iconVentosa} loading='lazy' className='img-item' alt='Icone para representar a ventosa, ou a ventosaterapia'/>
                        ...
                        <div className='item-div-mobile'>
                            <img src={moxaEmSantos} loading='lazy' className='image-mobile' alt='Foto de um sessão de Môxa'/>
                            <div className='item-text-div-mobile'>
                                <div className='title-item-div-mobile'>
                                    <img src={iconAcupuntura} loading='lazy' className='img-item' alt='Icone para representar a Môxa'/>
                        ...
                        <div className='item-div-mobile'>
                            <img src={eletroAcupunturaEmSantos} loading='lazy' className='image-mobile' alt='Foto de um sessão de eletroacupuntura'/>
                            <div className='item-text-div-mobile'>
                                <div className='title-item-div-mobile'>
                                    <img src={iconVentosa} loading='lazy' className='img-item' alt='Icone para representar a eletroacupuntura'/>
                        ...
                        <div className='item-div-mobile'>
                            <img src={namdaEmSantos} loading='lazy' className='image-mobile' alt='Foto de um sessão de NamDã'/>
                            <div className='item-text-div-mobile'>
                                <div className='title-item-div-mobile'>
                                    <img src={iconAcupuntura} loading='lazy' className='img-item' alt='Icone para representar a NamDã'/>
                        ...
                        <div className='item-div-mobile'>
                            <img src={fitoterapiaChinesaEmSantos} loading='lazy' className='image-mobile' alt='Foto de um sessão de Fitoterapia Chinesa'/>
                            <div className='item-text-div-mobile'>
                                <div className='title-item-div-mobile'>
                                    <img src={iconVentosa} loading='lazy' className='img-item' alt='Icone para representar a Fitoterapia Chinesa'/>
        ...
        <section id="Terapias" className="section-terapias">
            ...
            <div className='container-carousel'>
                <div className='carousel' ref={carousel}>
                    <div className='carrossel-item first-item'> 
                        <div className='item-div'>
                            ...
                            <img src={imageAcupuntura} loading='lazy' className='image-terapias-home' style={{marginLeft: 150}} alt='Foto de um sessão de acupuntura'/>
                        </div>
                    </div>
                    <div className='carrossel-item'>
                        <div className='item-div'>
                            <img src={imagemVentosaterapia} loading='lazy' className='image-terapias-home' style={{marginRight: 150}} alt='Foto de uma sessão de ventosaterapia'/>
                    ...
                    <div className='carrossel-item'>    
                        <div className='item-div'>
                            <div className='item-text-div'>
                                <div className='title-item-div'>
                                    <img src={iconAcupuntura} loading='lazy' style={{marginRight: 150}} className='img-item' alt='Icone para representar a Môxa'/>
                            ...
                            <img src={moxaEmSantos} loading='lazy' className='image-terapias-home' style={{marginLeft: 150}} alt='Foto de um sessão de Môxa'/>
                        </div>
                    </div>
                    <div className='carrossel-item'>    
                        <div className='item-div'>
                            <img src={eletroAcupunturaEmSantos} className='image-terapias-home' loading='lazy' style={{marginRight: 150}} alt='Foto de uma sessão de Môxa'/>
                            <div className='item-text-div-right'>
                                <div className='title-item-div-right'>
                    ...
                    <div className='carrossel-item'>    
                        <div className='item-div'>
                            ...
                            <img src={namdaEmSantos} className='image-terapias-home' loading='lazy' style={{marginLeft: 150}} alt='Foto de um sessão de eltroacupuntura'/>
                        </div>
                    </div>
                    <div className='carrossel-item last'>    
                        <div className='item-div'>
                            <img src={fitoterapiaChinesaEmSantos} loading='lazy' className='image-terapias-home' style={{marginRight: 150}} alt='Foto de uma sessão de NamDã'/>
                            <div className='item-text-div-right'>
                                <div className='title-item-div-right'>
                ...
                <div className='buttons'>
                    <button onClick={handleLeftClick}><img src={arrow} loading='lazy' alt="Proximo slide"/></button>
                    <button onClick={handleRightClick}><img src={arrow} loading='lazy' alt="Último slide"/></button>
                </div>
            </div>
